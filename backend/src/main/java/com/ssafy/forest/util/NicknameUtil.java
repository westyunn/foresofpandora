...
public class NicknameUtil {
    ...
    public String[] nicknames = {
        ...
        "날렵한 코요테", "촉촉한 카멜레온", "화려한 황소", "무뚝뚝한 사슴", "신중한 오리", "빠른 밍크", "활기찬 사슴벌레", "유쾌한 알파카", "화은려한 피그미 고슴도치", "뚜렷한 돌고래",
        "우아한 아르마딜로", "활발한 개미", "놀라운 오소리", "활기찬 지렁이", "우아한 코뿔소", "단단한 토끼", "미끄러운 미어캣", "길쭉한 고릴라", "화려한 햇살 고양이", "해맑은 기린",
        "우아한 플라밍고", "유연한 말랭이", "촉촉한 펭귄", "달콤한 판다", "날렵한 뱀", "매력적인 코알라한", "빠른 푸들", "부드러운 개구리", "차분한 토끼", "빠른 햄스터",
        ...
        "뚜렷한 돌고래", "우아한 햄스터", "활발한 푸른색 개미", "놀라운 오소리", "활기찬 무당벌레", "우아한 지렁이", "단단한 사슴벌레", "미끄러운 미어캣", "길쭉한 고릴라", "화려한 사자",
    ...
    public String hash(long num) {
        ...
        return sb.append(nicknames[(int) hash % nicknames.length]).append(" #").append(val.substring(val.length()-4)).toString();
    }
